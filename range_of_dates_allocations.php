 ...
 <div class="row">
    	<div align="center" class="col-sm-6 col-sm-offset-3" style="margin-top:3%; background-color:#0093af; padding:5px; color:#FFF; 
                -webkit-border-radius:10px; -moz-border-radius:10px; border-radius:10px">
                        A Specific Day's Allocation
                        <form class="form-horizontal" method="post" name="register" action="specific_day_allocation_action.php" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" class="btn btn-default">View Allocations</button>
                        </form> <br>
                        
                        
                        OR<br />
						A Range Of Dates' Allocations
                        
                        
                        
                        <form class="form-horizontal" method="post" name="register" action="range_of_days_allocation_action.php" enctype="multipart/form-data">
