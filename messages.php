                            ...
                            <?php 
								...
								while ($row_select=mysql_fetch_array($res_select, MYSQL-ASSOC))
								{
									...
									<tr style='border:thin solid; height:10px'>
										...
										<td style='border-top:thin solid #C4C4C4; padding-left:10px; padding-top:5px; padding-bottom:5px;'>$number</td>
										<td style='border-top:thin solid #C4C4C4; padding-left:10px; padding-top:5px; padding-bottom:5px;'>$message</td>
										<td style='border-top:thin solid #C4C4C4; padding-left:10px; padding-top:5px; padding-bottom:5px;'>
											<a rel='facebox' href='popups/deletemessage.php?id=$id' title='click here to delete this message'>Delete</a> 
										</td>
