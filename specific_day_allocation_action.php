...
<div style="margin-top:20px" class="col-sm-12"> 
                ...
                <table cellspacing="0px" class="col-sm-12" style="float:left; text-align:left; border:thin solid #A3A3A3; margin-bottom:10px;">                        	
                            ...
                            <?php 
								...
								$sql_select="SELECT * FROM allocations WHERE date='$specific_date' AND department='$department'";
					...
					$total_alloc="SELECT SUM(amount) FROM allocations WHERE date='$specific_date' AND department='$department'";
