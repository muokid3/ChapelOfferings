...
<div style="margin-top:20px" class="col-sm-12"> 
                ...
                <table cellspacing="0px" class="col-sm-12" style="float:left; text-align:left; border:thin solid #A3A3A3; margin-bottom:10px;">                        	
                            <thead>
								<tr height="40" >
									...
									<th class="col-sm-1"> Amount Allocated </th>
                            ...
                            <?php 
								...
								$sql_select="SELECT * FROM allocations WHERE department='$department' AND
								 ((date<='$date2' AND date>='$date1') OR (date<='$date1' AND date>='$date2')) ";
					...
					$total_alloc="SELECT SUM(amount) FROM allocations WHERE department='$department' AND
								 ((date<='$date2' AND date>='$date1') OR (date<='$date1' AND date>='$date2'))";
		...
		alert('You Must Select a Department and a Range of Dates!');
		window.location='range_of_dates_allocations.php';
	</script>";
			}
				?>
