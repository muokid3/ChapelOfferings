...
<title>Reports - Chapel Union</title>
...
<body>
    ...
    <div class="row" style="margin-top:5px">
                    ...
                    <div class="col-sm-2">
                      ...
                      <div style="margin-top:20px">
                        	<center>
                            	...
                            	<a href="specific_day_report.php" target="admin"> Specific Day's Report </a>|
                                <a href="income_report.php" target="admin"> Income Report </a>|
       ...
       <div class="row"> 
       		...
       		<div align="center" class="col-sm-10 col-sm-offset-1" style="height:auto; font-size:16px; border:double #55C8FF; float:left; margin-top:20px; margin-bottom:30px;">  
