...
<title>Allocations - Chapel Union</title>
...
<body>
    ...
    <div class="row" style="margin-top:5px">
    	...
    	<div class="row" style="margin-top:2%; border-bottom:3px solid #c7c7c7">
        	<div align="center" style="float:left; padding-bottom:5px; background-color:#FFF" class="col-sm-12">
        			...
        			<div style="margin-top:20px">
                      ...
                      <div style="margin-top:20px">
                        	<center>
                            	<a href="current_balance.php" target="admin">Current Balance </a>|
                                <a href="the_allocations.php" target="admin">Today's Allocations </a>|
                            	<a href="range_of_dates_allocations.php" target="admin"> Range of dates' allocation </a>                                
       ...
       <iframe src="current_balance.php" width="100%" height="480px" name="admin" frameborder="0" style="margin-top:10px; margin-bottom:10px; overflow:scroll;"></iframe>	
