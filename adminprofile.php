...
<title>Admin profile - Chapel Union</title>
...
<body>
    ...
    <div class="row" style="margin-top:5px">
        	...
        	<div align="center" style="float:left; padding-bottom:5px; background-color:#FFF" class="col-sm-12">
        			...
        			<div style="margin-top:20px">
                      ...
                      <div style="margin-top:50px">
                        	<center>
                            	<a rel="facebox" href="popups/addadmin.php">Add New Admin </a>|
                                <a rel="facebox" href="popups/add_user.php">Add New User </a>|
                            	<a rel="facebox" href="popups/changepassword.php"> Change Password </a>|
                            	<a href="messages.php" target="admin" class="glinks"> Read Messages</a>
                       		</center>
                       </div>
       ...
       <iframe src="users.php" width="100%" height="480px" name="admin" frameborder="0" style="margin-top:10px; margin-bottom:10px; overflow:scroll;"></iframe>	
