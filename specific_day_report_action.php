...
<div style="margin-top:20px" class="col-sm-12"> 
                ...
                <table cellspacing="0px" class="col-sm-12" style="float:left; text-align:left; border:thin solid #A3A3A3; margin-bottom:10px;">                        	
                            ...
                            <?php 
								...
								$sql_select="SELECT * FROM offerings WHERE date='$specific_date'";
					...
					$sql_one_total="SELECT SUM(one_shilling) FROM offerings WHERE date='$specific_date'";
					...
					$sql_five_total="SELECT SUM(five_shilling) FROM offerings WHERE date='$specific_date'";
					...
					$sql_ten_total="SELECT SUM(ten_shilling) FROM offerings WHERE date='$specific_date'";
					...
					$sql_twenty_total="SELECT SUM(twenty_shilling) FROM offerings WHERE date='$specific_date'";
					...
					$sql_forty_total="SELECT SUM(forty_shilling) FROM offerings WHERE date='$specific_date'";
					...
					$sql_fifty_total="SELECT SUM(fifty_shilling) FROM offerings WHERE date='$specific_date'";
					...
					$sql_hundred_total="SELECT SUM(hundred_shilling) FROM offerings WHERE date='$specific_date'";
					...
					$sql_two_hundred_total="SELECT SUM(two_hundred_shilling) FROM offerings WHERE date='$specific_date'";
					...
					$sql_five_hundred_total="SELECT SUM(five_hundred_shilling) FROM offerings WHERE date='$specific_date'";
					...
					$sql_thousand_total="SELECT SUM(thousand_shilling) FROM offerings WHERE date='$specific_date'";
		...
		window.location='specific_day_report.php';
	</script>";
			}
				?>
